...
<section class="eligibility_criteria_5">
    <div class="container">
        ...
        <?php
            ...
            <div class="main-box">
                <div class="toggle_heading toggle_btn">
                    <h1>Q: How can I apply for a program?</h1>
                    <p class="plus"> <i class="fa-solid fa-plus"></i></p>
                    <p class="minus"><i class="fa-solid fa-minus"></i></p>
                </div>
                <div class="toggle_content">
            ...
            <div class="main-box">
                <div class="toggle_heading toggle_btn">
                    <h1>Q: What is the deadline for program applications?</h1>
                    <p class="plus"> <i class="fa-solid fa-plus"></i></p>
                    <p class="minus"><i class="fa-solid fa-minus"></i></p>
                </div>
                <div class="toggle_content">
            ...
            <div class="main-box">
                <div class="toggle_heading toggle_btn">
                    <h1>Q: Can I apply for more than one program simultaneously?</h1>
                    <p class="plus"> <i class="fa-solid fa-plus"></i></p>
                    <p class="minus"><i class="fa-solid fa-minus"></i></p>
                </div>
                <div class="toggle_content">
            ...
            <div class="main-box">
                <div class="toggle_heading toggle_btn">
                    <h1>Q: Are there any scholarships or financial aid options available?</h1>
                    <p class="plus"> <i class="fa-solid fa-plus"></i></p>
                    <p class="minus"><i class="fa-solid fa-minus"></i></p>
                </div>
                <div class="toggle_content">
            ...
            <div class="main-box">
                <div class="toggle_heading toggle_btn">
                    <h1>Q: What is the duration of the programs?</h1>
                    <p class="plus"> <i class="fa-solid fa-plus"></i></p>
                    <p class="minus"><i class="fa-solid fa-minus"></i></p>
                </div>
                <div class="toggle_content">
            ...
            <div class="main-box">
                <div class="toggle_heading toggle_btn">
                    <h1>Q: Can I complete the programs online, or do I need to be on-site?</h1>
                    <p class="plus"> <i class="fa-solid fa-plus"></i></p>
                    <p class="minus"><i class="fa-solid fa-minus"></i></p>
                </div>
                <div class="toggle_content">
            ...
            <div class="main-box">
                <div class="toggle_heading toggle_btn">
                    <h1>Q: What happens after I complete a program?</h1>
                    <p class="plus"> <i class="fa-solid fa-plus"></i></p>
                    <p class="minus"><i class="fa-solid fa-minus"></i></p>
                </div>
                <div class="toggle_content">
