            ...
            <div class="col-md-3 p-2">
                <div class="box">
                    <div class="text">
                        ...
                        <p>Build the look and feel of websites and applications.</p>
                    </div>
                    <div class="img">
                        <img src="./assets/images/program_box_bg_2.png" alt="">
                    </div>
                </div>
            </div>
            <div class="col-md-3 p-2">
                <div class="box">
                    <div class="text">
                        ...
                        <p>Create the brains behind web systems and databases.</p>
                    </div>
                    <div class="img">
                        <img src="./assets/images/program_box_bg_3.png" alt="">
                    </div>
                </div>
            </div>
            <div class="col-md-3 p-2">
                <div class="box">
                    <div class="text">
                        ...
                        <p>Master online brand promotion and customer engagement.</p>
                    </div>
                    <div class="img">
                        <img src="./assets/images/program_box_bg_4.png" alt="">
                    </div>
                </div>
            </div>
            <div class="col-md-3 p-2">
                <div class="box">
                    <div class="text">
                        ...
                        <p>Develop mobile apps for Android and iOS.</p>
                    </div>
                    <div class="img">
                        <img src="./assets/images/program_box_bg_5.png" alt="">
                    </div>
                </div>
            </div>
            <div class="col-md-3 p-2">
                <div class="box">
                    <div class="text">
                        ...
                        <p>Become a versatile developer using Python.</p>
                    </div>
                    <div class="img">
                        <img src="./assets/images/program_box_bg_6.png" alt="">
                    </div>
                </div>
            </div>
            <div class="col-md-3 p-2">
                <div class="box">
                    <div class="text">
                        ...
                        <p>Craft complete web solutions using the latest technologies.</p>
                    </div>
                    <div class="img">
                        <img src="./assets/images/program_box_bg_7.png" alt="">
                    </div>
                </div>
            </div>
            <div class="col-md-3 p-2">
                <div class="box">
                    <div class="text">
                        <h4>Full Stack Django</h4>
                        <p>Master the Django framework for web development.</p>
                    </div>
                    <div class="img">
                        <img src="./assets/images/program_box_bg_8.png" alt="">
                    </div>
                </div>
            </div>
            <div class="col-md-3 p-2">
                <div class="box">
                    <div class="text">
                        ...
                        <p>Analyze data to make informed business decisions.</p>
                    </div>
                    <div class="img">
                        <img src="./assets/images/program_box_bg_9.png" alt="">
                    </div>
                </div>
            </div>
            <div class="col-md-3 p-2">
                <div class="box">
                    <div class="text">
                        ...
                        <p>Teach computers to learn and make predictions.</p>
                    </div>
                    <div class="img">
                        <img src="./assets/images/program_box_bg_10.png" alt="">
                    </div>
                </div>
            </div>
            <div class="col-md-3 p-2">
                <div class="box">
                    <div class="text">
                        ...
                        <p>Explore the limitless possibilities of AI.</p>
                    </div>
                    <div class="img">
                        <img src="./assets/images/program_box_bg_11.png" alt="">
                    </div>
                </div>
            </div>
            <div class="col-md-3 p-2">
                <div class="box">
                    <div class="text">
                        ...
                        <p>Connect and control devices for a smart world.</p>
                    </div>
                    <div class="img">
                        <img src="./assets/images/program_box_bg_12.png" alt="">
                    </div>
                </div>
            </div>
            <div class="col-md-3 p-2">
                <div class="box">
                    <div class="text">
                        <h4>Campus Ambassador Program (CAP)</h4>
                        <p>Become a brand ambassador for DigitalShakha on your campus.</p>
                    </div>
                    <div class="img">
