...
<div class="page-header">
    <h3 class="page-title">Program Detail view </h3>
    ...
    <div class="col-lg-12 grid-margin stretch-card">
        <div class="col-md-12 p-0 app-click">
            <div class="row app_view">
                ...
                <div class="col-md-4 mb-2">
                    <label>Status</label>
                    <?php if ($row['program_detail_status'] != '') : ?>
                        <p><?php if ($row['program_detail_status'] == 1) {
                                echo "Active";
                            } else {
                                echo "Inactive";
                            }
                ...
                <div class="col-md-4 mb-2">
                    <label>Heading</label>
                    <br>
                    <?php if ($row['program_detail_heading'] != '') : ?>
                        <p><?=$row['program_detail_heading']?></p>
                    <?php else : ?>
                        <p>Not Found</p>
                    <?php endif ?>
                </div>
                ...
                <div class="col-md-6">
                    ...
                    <br>
                    <?php if ($row['program_detail_description'] != '') : ?>
                        <p><?=$row['program_detail_description']?></p>
                    <?php else : ?>
                        <p>Not Found</p>
                    <?php endif ?>
                </div>
