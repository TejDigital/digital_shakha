...
<div class="modal fade" id="Add_about" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <form action="./program_about_code.php" method="POST" enctype="multipart/form-data">
                ...
                <div class="modal-body">
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <select name="program_name" class="form-control mb-2">
                        ...
                        <div class="col-md-12">
                           ...
                           <textarea name="description" class="form-control mb-2 textarea" cols="30" rows="10"></textarea>
                        </div>
                    </div>
                </div>
