...
if (isset($_GET['id'])) {
    ...
    $sql = "SELECT * FROM internship_course_material_tbl WHERE course_material_id = '$id'";
...
<div class="page-header">
    <h3 class="page-title">Course Material Edit </h3>
...
<div class="row">
    <div class="col-lg-12 grid-margin stretch-card">
        <div class="col-md-12 p-0 app-click">
            <form action="./internship_track_course_material_edit_code.php" method="post" enctype="multipart/form-data">
                <input type="hidden" value="<?= $row['course_material_id'] ?>" name="id">
                <div class="row">
                    <div class="col-md-4">
                    ...
                    <div class="col-md-4">
                        ...
                        <select name="status" class="form-select mb-2" style="appearance: revert;background:#2A3038 !important; color:#fff !important;">
                            <option <?php if ($row['material_status'] == 1) {
                                        echo "selected";
                                    } ?> value="1">Active</option>
                            <option <?php if ($row['material_status'] == 0) {
                                        echo "selected";
                    ...
                    <div class="col-md-4">
                        ...
                        <input type="text"name="material_name" value="<?=$row['material_name']?>" class="form-control">
                    </div>
                    <div class="col-md-4">
                        <label for="">Current File</label> <br>
                        <a href="./course_material_files/<?= $row['material'] ?>" target="_blank">Click to view</a>
                        <br>
                        <input type="hidden" name="old_file" value="<?= $row['material'] ?>">
