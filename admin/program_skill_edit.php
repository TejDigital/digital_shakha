...
<div class="page-header">
    <h3 class="page-title">Program skill Edit </h3>
...
<div class="row">
    <div class="col-lg-12 grid-margin stretch-card">
        <div class="col-md-12 p-0 app-click">
            <form action="./program_skill_edit_code.php" method="post">
                <input type="hidden" value="<?= $row['program_skill_id'] ?>" name="id">
                <div class="row">
                    <div class="col-md-4">
                    ...
                    <div class="col-md-4">
                        ...
                        <select name="status" class="form-select mb-2"  style="appearance: revert;background:#2A3038 !important; color:#fff !important;">
                            <option <?php if ($row['program_skill_status'] == 1) {
                                        echo "selected";
                                    } ?> value="1">Active</option>
                            <option <?php if ($row['program_skill_status'] == 0) {
                                        echo "selected";
                    ...
                    <div class="col-md-4">
                        ...
                        <input type="text" name="skill" value="<?= $row['program_skill_name'] ?>" class="form-control mb-2 ">
                    </div>
