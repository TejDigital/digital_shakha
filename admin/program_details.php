...
<div class="modal fade" id="Add_detail" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <form action="./program_detail_code.php" method="POST" id="program_detail_form">
                ...
                <div class="modal-body">
                    <div class="row">
                        ...
                        <div class="col-md-4 mb-2">
                            ...
                            <input type="text" class="form-control " name="heading" placeholder="type heading">
                        </div>
                        <div class="col-md-4 mb-2">
