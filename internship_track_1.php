                    ...
                    <div class="progress_category">
                        ...
                        ?>
                                    ...
                                    <div class="progress_list toggle_content">
                                        <ul>
                                            <li class="click_btn" onclick="ontablink(event,'box2<?= $programs['program_id'] ?>')" id="event"> <span class="arrow_icon"><i class="fa-solid fa-angle-right"></i></span>Course Materials</li>
